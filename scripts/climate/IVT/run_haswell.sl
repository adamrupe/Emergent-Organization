...
#SBATCH -C haswell
#SBATCH -J IVT-seg8
#SBATCH -o /global/project/projectdirs/ProjectDisCo/Adam/climate/IVT/result-8/params.log
#SBATCH -e /global/project/projectdirs/ProjectDisCo/Adam/climate/IVT/result-8/run.err
...
srun -n 500 python -m tbb -p 32 --ipc /global/common/software/ProjectDisCo/Adam/climate/IVT/climate.py 
