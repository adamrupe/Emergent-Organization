...
#SBATCH -C haswell
#SBATCH -J TMQseg11
#SBATCH -o /global/project/projectdirs/ProjectDisCo/Adam/climate/TMQ/result-11/params.log
#SBATCH -e /global/project/projectdirs/ProjectDisCo/Adam/climate/TMQ/result-11/run.err
...
srun -n 500 python -m tbb -p 32 --ipc /global/common/software/ProjectDisCo/Adam/climate/TMQ/climate.py 
