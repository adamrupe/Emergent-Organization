...
#SBATCH -C haswell
#SBATCH -J TMQ_PSL12
#SBATCH -o /global/project/projectdirs/ProjectDisCo/Adam/climate/TMQ_PSL/result-12/params.log
#SBATCH -e /global/project/projectdirs/ProjectDisCo/Adam/climate/TMQ_PSL/result-12/run.err
...
srun -n 500 python -m tbb -p 32 --ipc /global/common/software/ProjectDisCo/Adam/climate/TMQ_PSL/climate.py 
