...
# recon3.plcs = StandardScaler().fit_transform(recon3.plcs)
# recon3.flcs = StandardScaler().fit_transform(recon3.flcs)
del Vfield
...
plcs_1 = (reconU.plcs*reconQ.plcs)**4
plcs_2 = (reconV.plcs*reconQ.plcs)**4
...
flcs_1 = (reconU.flcs*reconQ.flcs)**4
flcs_2 = (reconV.flcs*reconQ.flcs)**4
...
if rank == 0:
    full_end = time.time()
    print("Multivariate analysis with lightcone metric to replicate IVT---(U850*TMQ)^4 concat (V850*TMQ)^4 lightcones---spacetime decays applied appropriately.")
